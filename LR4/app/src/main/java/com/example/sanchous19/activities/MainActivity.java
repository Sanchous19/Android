...
import com.example.sanchous19.Post;
import com.example.sanchous19.PostAdapter;
import com.example.lab4_rss.R;
import com.example.sanchous19.RssData;
import com.example.sanchous19.RssDataController;
import com.example.sanchous19.network.NetworkChangeReceiver;
import com.example.sanchous19.network.NetworkState;
import com.example.sanchous19.network.NetworkUtil;

public class MainActivity extends AppCompatActivity implements RssData {
    ...
    public void setOfflineMode() {
        new RssDataController(this, postList, mSettings, false).execute(RSS);
    }

    public void setOnlineMode() {
        if (!RSS.isEmpty())
            new RssDataController(this, postList, mSettings, true).execute(RSS);
        else {
            showRssRequest();
        }
    }
